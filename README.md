...
<h3 align="center">Backend &nbsp;·&nbsp; Distributed Systems &nbsp;·&nbsp; Cloud &nbsp;·&nbsp; Applied AI</h3>

<p align="center">
  I build backends that stay correct under load: event-driven pipelines, idempotent processing,
  caching, queues, and the boring reliability work that keeps systems up.
  <br/>
  I'd rather show than tell. Everything below is real, runnable, and in the repos.
</p>
...
<p align="center">
  ...
  <a href="https://github.com/rshsreehari"><img src="https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub"/></a>
...
> The projects I'd point to first. Each one is a real system, not a toy wrapper.
...
### 🤖 [Agentic RAG System](https://github.com/rshsreehari/Agentic-RAG-system)
Retrieval-augmented generation with tool-use and planning. Being extended into a guarded **MCP server** with an evaluation harness and tracing.
> `Python` · `RAG` · `MCP` · `Prompt Engineering`

### 📷 [AICamera — On-Device Contextual AI (iOS)](https://github.com/rshsreehari/AICamera)
An iOS app exploring on-device vision and inference with AVFoundation, VisionKit, and CoreML.
> `Swift` · `CoreML` · `VisionKit` · `AVFoundation`
